...
// Tu código acá:
document.querySelector('#createdBy').innerHTML += "Hercy";
...
function addToDo() {
  ...
  toDoItems.push(new ToDo(toDoInput.value)); //Agregar el objeto ToDo recién creado al array toDoItems
  toDoInput.value = "";
  displayToDos();
}
